            ...
            >
              ...
              <div className="space-y-6">
                ...
                <motion.button 
                  ...
                  onClick={() => {
                    if (order?.orderId) {
                      addNotification('order_placed', 'Order Confirmed', `Your laundry request ${order.orderId} has been successfully queued.`, 'user');
                      addNotification('order_placed', `New Order ${order.orderId}`, 'A new laundry request is available for pickup.', 'rider');
                    }
